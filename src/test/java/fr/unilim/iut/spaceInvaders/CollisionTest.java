...
public class CollisionTest {
	...
	public void test_PasDeCollisionDetecte() {
		...
		assertEquals(false,
				collision.detecterCollision(spaceinvaders.recupererVaisseau(), spaceinvaders.recupererEnvahisseur()));
	}
	...
	public void test_collisionLaPlusNormal() {
		...
		assertEquals(true, collision.detecterCollision(spaceinvaders.recupererEnvahisseur(),
	...
	public void test_DetectionCollision_ParLeBas() {
		...
		spaceinvaders.positionnerUnNouveauEnvahisseur(new Dimension(4, 3), new Position(7, 3), 1);
		assertEquals(true,
				collision.detecterCollision(spaceinvaders.recupererVaisseau(), spaceinvaders.recupererEnvahisseur()));
	}
	...
	public void test_DetectionCollision_EnvahisseurMissile() {
		...
		spaceinvaders.positionnerUnNouveauEnvahisseur(new Dimension(10, 2), new Position(0, 5), 1);
